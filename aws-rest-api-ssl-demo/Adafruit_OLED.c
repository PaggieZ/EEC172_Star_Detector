...
//*****************************************************************************
#define SPI_IF_BIT_RATE  1600000
...
*/
    //Message("Writing Command...\n\r");
            unsigned char ulUserData;

            MAP_GPIOPinWrite(GPIOA3_BASE, DC_Pin, 0x00);
            ...
            //
            MAP_SPITransfer(GSPI_BASE,&ulUserData,g_ucRxBuff,1,
...
*/
    //Message("Writing Data...\n\r");
        ...
        MAP_GPIOPinWrite(GPIOA3_BASE, DC_Pin, 0xff);
